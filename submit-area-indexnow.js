...
const urls = [
  ...
  'https://alexchalu.github.io/toolpulse/convert-acres-to-square-miles.html',
  ...
  'https://alexchalu.github.io/toolpulse/convert-square-miles-to-acres.html',
  ...
  'https://alexchalu.github.io/toolpulse/convert-square-kilometers-to-hectares.html',
  'https://alexchalu.github.io/toolpulse/convert-square-kilometers-to-acres.html',
];
...
const req = https.request(options, (res) => {
  ...
  if (res.statusCode === 200) {
    console.log('✅ Successfully submitted 20 area conversion URLs to IndexNow');
  }
});
